...
for dms in dms_runs:
    if dataset == 'animals':
        ...
        ii_pairs = [(dogs, cuddling), (cats, alone), (dogs, depend), (cats, independent), (dogs, bark), (cats, meow),
                    (lions, wild), (lions, hunt)]
        ij_pairs = [(dogs, alone), (dogs, independent), (dogs, meow), (dogs, wild), (dogs, hunt), (cats, cuddling),
                    (cats, depend), (cats, bark), (cats, wild), (cats, hunt), (lions, cuddling), (lions, alone),
                    (lions, depend),
                    (lions, independent), (lions, bark), (lions, meow)]
        ...
        ii_pairs = [(a1, a2), (a1, a3), (a2, a3), (b1, b2), (b1, b3), (b2, b3), (c1, c2), (c1, c3), (c2, c3)]
        ij_pairs = [(a1, b1), (a1, b2), (a1, b3), (a2, b1), (a2, b2), (a2, b3), (a3, b1), (a3, b2), (a3, b3),
...
print(ii_sim)
print(ij_sim)
print('sim_ii', sum(ii_sim)/dms_runs.shape[0])
print('sim_ij', sum(ij_sim)/dms_runs.shape[0])